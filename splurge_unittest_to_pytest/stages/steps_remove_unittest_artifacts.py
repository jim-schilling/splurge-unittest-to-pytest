"""Steps for removing unittest artifacts: Parse -> Transform"""
...
DOMAINS = ["stages", "helpers", "steps"]


@dataclass
class ParseRemoveUnittestStep:
    id: str = "steps.remove_unittest.parse"
...
@dataclass
class RemoveUnittestArtifactsStep:
    id: str = "steps.remove_unittest.transform"
    ...
    def execute(self, context: Mapping[str, Any], resources: Any) -> StepResult:
        ...
        # Reuse the transformer logic from the legacy Task implementation
...
__all__ = ["ParseRemoveUnittestStep", "RemoveUnittestArtifactsStep"]
