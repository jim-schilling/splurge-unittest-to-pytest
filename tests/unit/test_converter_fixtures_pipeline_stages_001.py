...
DOMAINS = ["converter", "fixtures", "pipeline", "stages"]


def test_pattern_matching_helpers():
    # Verify the extracted, public pattern helpers behave as expected
...
def test_remove_unittest_main_guard_with_pipeline():
    ...
    # Expect main guard removed, leaving only assignment
...
def test_assert_raises_converts_and_injects_pytest_import():
    ...
    # The staged pipeline should add pytest import when raises contexts are rewritten
