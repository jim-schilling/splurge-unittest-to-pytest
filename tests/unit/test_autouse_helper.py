from splurge_unittest_to_pytest.converter.autouse import build_attach_to_instance_fixture, insert_attach_fixture_into_module
...
def test_insert_attach_fixture_into_module():
    ...
    func = build_attach_to_instance_fixture({"res": cst.FunctionDef(name=cst.Name("res"), params=cst.Parameters(), body=cst.IndentedBlock(body=[]))})
